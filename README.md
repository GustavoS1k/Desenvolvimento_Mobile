...
Ao abrir o aplicativo, o usuário encontrará uma tela de login.
...
⚙️ Observações
O aplicativo não utiliza banco de dados (dados não são salvos ao fechar)
O login é apenas ilustrativo
